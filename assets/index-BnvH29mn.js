 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yf;const KA=()=>(yf||(yf=new gt(kC)),yf);class Ae{static fromObject(t){let i=new Ae(null);return yt(t,(r,o)=>{i=i.set(new Se(r),o)}),i}constructor(t,i=KA()){this.value=t,this.children=i}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(t,i){if(this.value!=null&&i(this.value))return{path:ce(),value:this.value};if(se(t))return null;{const r=ae(t),o=this.children.get(r);if(o!==null){const c=o.findRootMostMatchingPathAndValue(Te(t),i);return c!=null?{path:qe(new Se(r),c.path),value:c.value}:null}else return null}}findRootMostValueAndPath(t){return this.findRootMostMatchingPathAndValue(t,()=>!0)}subtree(t){if(se(t))return this;{const i=ae(t),r=this.children.get(i);return r!==null?r.subtree(Te(t)):new Ae(null)}}set(t,i){if(se(t))return new Ae(i,this.children);{const r=ae(t),c=(this.children.get(r)||new Ae(null)).set(Te(t),i),h=this.children.insert(r,c);return new Ae(this.value,h)}}remove(t){if(se(t))return this.children.isEmpty()?new Ae(null):new Ae(null,this.children);{const i=ae(t),r=this.children.get(i);if(r){const o=r.remove(Te(t));let c;return o.isEmpty()?c=this.children.remove(i):c=this.children.insert(i,o),this.value===null&&c.isEmpty()?new Ae(null):new Ae(this.value,c)}else return this}}get(t){if(se(t))return this.value;{const i=ae(t),r=this.children.get(i);return r?r.get(Te(t)):null}}setTree(t,i){if(se(t))return i;{const r=ae(t),c=(this.children.get(r)||new Ae(null)).setTree(Te(t),i);let h;return c.isEmpty()?h=this.children.remove(r):h=this.children.insert(r,c),new Ae(this.value,h)}}fold(t){return this.fold_(ce(),t)}fold_(t,i){const r={};return this.children.inorderTraversal((o,c)=>{r[o]=c.fold_(qe(t,o),i)}),i(t,this.value,r)}findOnPath(t,i){return this.findOnPath_(t,ce(),i)}findOnPath_(t,i,r){const o=this.value?r(i,this.value):!1;if(o)return o;if(se(t))return null;{const c=ae(t),h=this.children.get(c);return h?h.findOnPath_(Te(t),qe(i,c),r):null}}foreachOnPath(t,i){return this.foreachOnPath_(t,ce(),i)}foreachOnPath_(t,i,r){if(se(t))return this;{this.value&&r(i,this.value);const o=ae(t),c=this.children.get(o);return c?c.foreachOnPath_(Te(t),qe(i,o),r):new Ae(null)}}foreach(t){this.foreach_(ce(),t)}foreach_(t,i){this.children.inorderTraversal((r,o)=>{o.foreach_(qe(t,r),i)}),this.value&&i(t,this.value)}foreachChild(t){this.children.inorderTraversal((i,r)=>{r.value&&t(i,r.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{constructor(t){this.writeTree_=t}static empty(){return new Kt(new Ae(null))}}function ur(a,t,i){if(se(t))return new Kt(new Ae(i));{const r=a.writeTree_.findRootMostValueAndPath(t);if(r!=null){const o=r.path;let c=r.value;const h=ut(o,t);return c=c.updateChild(h,i),new Kt(a.writeTree_.set(o,c))}else{const o=new Ae(i),c=a.writeTree_.setTree(t,o);return new Kt(c)}}}function xg(a,t,i){let r=a;return yt(i,(o,c)=>{r=ur(r,qe(t,o),c)}),r}function kg(a,t){if(se(t))return Kt.empty();{const i=a.writeTree_.setTree(t,new Ae(null));return new Kt(i)}}function Uf(a,t){return Ki(a,t)!=null}function Ki(a,t){const i=a.writeTree_.findRootMostValueAndPath(t);return i!=null?a.writeTree_.get(i.path).getChild(ut(i.path,t)):null}function Ug(a){const t=[],i=a.writeTree_.value;return i!=null?i.isLeafNode()||i.forEachChild(Ie,(r,o)=>{t.push(new te(r,o))}):a.writeTree_.children.inorderTraversal((r,o)=>{o.value!=null&&t.push(new te(r,o.value))}),t}function fi(a,t){if(se(t))return a;{const i=Ki(a,t);return i!=null?new Kt(new Ae(i)):new Kt(a.writeTree_.subtree(t))}}function Lf(a){return a.writeTree_.isEmpty()}function Fs(a,t){return Ry(ce(),a.writeTree_,t)}function Ry(a,t,i){if(t.value!=null)return i.updateChild(a,t.value);{let r=null;return t.children.inorderTraversal((o,c)=>{o===".priority"?(U(c.value!==null,"Priority writes must always be leaf nodes"),r=c.value):i=Ry(qe(a,o),c,i)}),!i.getChild(a).isEmpty()&&r!==null&&(i=i.updateChild(qe(a,".priority"),r)),i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
